 ...
 *
 * A Preferences repository manages preferences (like settings) by saving and
 ...
 *
 *   $preferences = Repository::factory('preferences');
 ...
 */
class Repository_Preferences extends Repository
{
	...
	protected function _get_mapper ()
	{
		return Repository_Mapper::factory()->initialize(array(
			'query' => Kohana:$cache_dir.'repository/preferences',
			'type' => 'preferences'
		));
	}
